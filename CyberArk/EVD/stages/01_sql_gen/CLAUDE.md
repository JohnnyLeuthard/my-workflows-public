...
- **Output location**: Write the SQL query to `stages/01_sql_gen/output/query.sql` (canonical path from the EVD folder root). Stop after writing this file and wait for human review.
